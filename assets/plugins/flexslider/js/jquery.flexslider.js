...
(function ($) {
  ...
  $.flexslider.defaults = {
    ...
    selector: ".slides > div.slide",       //{NEW} Selector: Must match a simple pattern. '{container} > {slide}' -- Ignore pattern at your own peril
  ...
  $.fn.flexslider = function(options) {
    ...
    if (typeof options === "object") {
      return this.each(function() {
        var $this = $(this),
            selector = (options.selector) ? options.selector : ".slides > div.slide",
