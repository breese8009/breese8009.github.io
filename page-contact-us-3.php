...
<head>
    ...
    <title>Page - Contact Us 3 | iMax</title>
...
<body class="switcher_boxed boxed">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="dropdown-submenu active">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a href="page-contact-us-2.php">Contact Us 2</a></li>
                                        <li class="active"><a href="page-contact-us-3.php">Contact Us 3</a></li>
                                    </ul>
                                </li>
                                <li class="dropdown-submenu">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-sm-8">
                    <h2 class="text-weight-300">Contact Us Three</h2>
                </div>
                <div class="col-md-4 col-sm-4 text-right breadcrumb-setting">
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-home"></i> Home</a></li>
                        <li><a href="#">Pages</a></li>
                        <li class="active">Contact Us 3</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <section class="padding-top-large padding-bottom-small">
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-sm-6 padding-bottom-medium">
                ...
                <div class="col-md-6 col-sm-6 padding-top-medium">
                    <!-- Begin: MAP -->
                    <div class="is-map width-100 height-500px" data-latlng="48.868974, 2.330663" data-zoom="13">
